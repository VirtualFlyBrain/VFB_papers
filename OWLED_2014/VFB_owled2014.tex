...
(See Osumi-Sutherland et al., 2014 for details.)
...
\textbf{expresses}
...
% Would be better if this were in common logic!  And what is y?
\end{quote}
...
clones and complete expression patterns.  Images of single neurons and neuron clones typically depict only
fragments of expression patterns.  To keep these
...
region Y'  (see \ref{fig:exp_pat_neg} for an example)\end{quote}
